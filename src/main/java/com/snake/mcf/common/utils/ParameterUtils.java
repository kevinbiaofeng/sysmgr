...
public class ParameterUtils {
    ...
    public ParameterUtils(Object params, String getMethodName) {
        ...
        try {
            ...
            if (!methodGetValue.getReturnType().equals(String.class)
                    || Modifier.isPublic(methodGetValue.getModifiers())) {
                throw new IllegalArgumentException(
     ...
     *
     * @param oriValue
     * @param trueFlag     代表true的标识，可以多个，以|分隔
     * @param defaultValue
     * @return
     */
    ...
    public static Map<Object,Object> extractByPrefix(Map<Object,Object> map, String prefixKey) {

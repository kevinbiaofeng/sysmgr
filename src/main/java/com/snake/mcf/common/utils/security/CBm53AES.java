...
public class CBm53AES {
    ...
    private static final char[] Sbox = new char[30000];
    private static final char[] InvSbox = new char[30000];
    private static final char[][][] w = new char[11][4][4];
    ...
    private void Cipher(char[] input, char[] output) {
     ...
     * @返回值： void
     *********************************************/
    private void CipherStr(char[] input, char[] output) {
    ...
    private void InvCipher(char[] input, char[] output) {
        char[] uch_input = new char[1024];
     ...
     * @返回值： void
     *********************************************/
    private void InvCipherStr(char[] input, char[] output) {
    ...
    private char[] Cipher(char[] input) {
    ...
    private char[] InvCipher(char[] input) {
        char[][] state = new char[4][4];
        int i, r, c;
        for (r = 0; r < 4; r++) {
            for (c = 0; c < 4; c++) {
    ...
    private void KeyExpansion(char[] key, char w[][][]) {
        int i, j, r, c;
    ...
    private int getUCharLen(char[] uch) {
        int len = 0;
        int i = 0;
        while (uch[i++] > 0)
            ++len;
    ...
    private int ucharToHex(char[] uch, char[] hex, int nLen) {
        int high, low;
        int tmp = 0;
    ...
    private int hexToUChar(char[] hex, char[] uch) {
        int high, low;
        int tmp = 0;
    ...
    private int strToUChar(char[] ch, char[] uch) {
        int tmp = 0;
        if (ch == null || uch == null)
            return -1;
        if (ch.length == 0)
    ...
    private int ucharToStr(char[] uch, char[] ch, int nlen) {
        int tmp = 0;
        if (uch == null || ch == null)
            return -1;
        int n = 0;
    ...
    private int strToHex(char[] ch, char[] hex) {
        int high, low;
        int tmp = 0;
        if (ch == null || hex == null) {
            return -1;
    ...
    private int hexToStr(char[] hex, char[] ch) {
        int high, low;
        int tmp = 0;
        if (hex == null || ch == null) {
            return -1;
    ...
    private int ascillToValue(char ch) {
        int result = 0;
        //获取16进制的高字节位数据
        if (ch >= '0' && ch <= '9') {
            result = (int) (ch - '0');
    ...
    private char valueToHexCh(int value) {
        char result = '\0';
        if (value >= 0 && value <= 9) {
    ...
    public static String encrypt(String str) {
    	char[] miwen = new char[102400];
    	CBm53AES aes = new CBm53AES(key);
    	aes.CipherStr(str.toCharArray(), miwen);
...
//        char mingwen[] = "LOGAN".toCharArray();
...
//        
//        aes.InvCipherStr("E6AE09D2A8C2E32AB9107B3FEEA73D64".toCharArray(), result);
//        StringBuilder sb = new StringBuilder();
//        for (int i = 0; i < result.length; i++) {
...
//        System.out.println(result);
    	String ss = CBm53AES.encrypt("中文"); //E6AE09D2A8C2E32AB9107B3FEEA73D64
    	System.out.println(ss);
    	System.out.println(CBm53AES.decrypt(ss));
    }
}

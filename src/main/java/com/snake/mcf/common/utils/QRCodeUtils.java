...
//    private static final String FORMAT = "JPG";
     ...
     * @throws Exception
     */
    public static String createQRCode(String content, String logoPath, String destPath, String fileName, boolean needCompress) throws Exception {
    ...
    public static void main(String[] args) throws Exception {
        String text = "asdsdasdasd！！！";
        //不含Logo
        QRCodeUtils.createQRCode(text, null, "D:\\cc\\", "qrcode", true);
        //含Logo，指定二维码图片名
        QRCodeUtils.createQRCode(text, "C:\\Users\\Administrator\\Desktop\\背景图\\下载.png", "d:\\cc\\", "qrcode1", true);
        System.out.println(QRCodeUtils.decode("d:\\cc\\qrcode.jpg"));

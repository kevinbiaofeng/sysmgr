...
<body>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading" >
		             	<span class="heading-font1">编辑亲友圈配置</span>
		            ...
		            <div class="panel-body">
		            	<form id="taskedit-form" method="post" data-options="novalidate:true" >
		            		<table class="form-table" border="0" cellpadding="1" cellspacing="2" width="100%">
								<tr>
									<td class="form-label">
										<label for="optionname1">键名：</label>
									</td>
									<td class="form-editor">
										<input id="optionname1" name="optionname" class="easyui-textbox" style="width: 350px;" data-options="required:true,disabled: true"/>
									</td>
									<td class="form-label">
	...
	<script type="text/javascript">
		...
		//ajax 加载form表单数据
		$.ajax({
			url: "${pageContext.request.contextPath}/ffar/stand/queryIMGroupOptionById",
			type: 'GET',
			dataType: 'json',
			data: {optionname: param.optionname},
		...
		$("#save").bind("click",function(){
			...
			var optionname = $('#optionname1').textbox('getValue');

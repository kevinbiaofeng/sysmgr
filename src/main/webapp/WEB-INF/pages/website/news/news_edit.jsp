			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading" >
		             	<span class="heading-font1">编辑公告信息</span>
		            ...
		            <div class="panel-body">
		            	<form id="taskedit-form" method="post" data-options="novalidate:true" >
							<input id="noticeid" name="noticeid" type="hidden" class="easyui-textbox" />
...
<%--											   			,{id: 2,text: '三端'},{id: 3,text: 'U3D'},{id: 4,text: 'H5'}--%>
	...
	<script type="text/javascript">
		...
		//ajax 加载form表单数据
		$.ajax({
			url: "${pageContext.request.contextPath}/website/news/querySystemNoticeById",
			type: 'GET',
			dataType: 'json',
			data: {noticeid: param.noticeid},
		...
		$("#save").bind("click",function(){
			...
			//提交到后台
			$.ajax({
				url: "${pageContext.request.contextPath}/website/news/updateSystemNotice",
				type: 'PUT',
				dataType: 'json',
				data: data,
				success: function(resp){

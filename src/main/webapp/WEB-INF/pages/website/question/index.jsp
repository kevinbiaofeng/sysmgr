		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel-body" >
					...
					<table id="datagrid1" class="easyui-datagrid" title="常见问题"
						...
						<tr>
							...
							<th data-options="field:'questiontitle',align:'center',fixed:false,width:60">问题</th>

							<th data-options="field:'answer',align:'center',fixed:false,width:60">答案</th>
							...
							<th data-options="field:'updateat',align:'center',fixed:false,width:30,formatter:function(value,row,index){return $.dateFormatter(value)}">修改时间</th>
	...
	<script type="text/javascript">
		...
		$(function($){
			...
			$("#add").bind("click",function(){
				$('#dialog').dialog({
					title: '新增常见问题',
					href: '${pageContext.request.contextPath}/website/question/toQuestionAddPage',
					width: 800,
					height: 400,
					closed: false,
					cache: false,
		...
		function search(){
			...
			$('#datagrid1').datagrid({
				url: '${pageContext.request.contextPath}/website/question/queryQuestionWithPage',
				view: myview,
				loadMsg: "数据加载中，请稍后！",
				emptyMsg: "未搜索到相关数据！"
			});
		...
		function openEditWindown(id){
			$('#dialog').dialog({
				title: '编辑常见问题',
				href: '${pageContext.request.contextPath}/website/question/toQuestionEditPage',
				dialogParams: {id: id},
				width: 1000,
				height: 500,
				closed: false,
		...
		function removeByids(){
			...
			$.messager.confirm('确认',"确定要删除选中的记录吗",function(r){
				if (r){
					...
					//提交到后台
					$.ajax({
						url: "${pageContext.request.contextPath}/website/question/removeQuestionByIds?ids="+nmArr,
						type: 'DELETE',
						//dataType: 'json',
						//data: data,

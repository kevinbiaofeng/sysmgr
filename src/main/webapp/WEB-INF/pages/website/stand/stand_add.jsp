...
<body>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading" >
		             	<span class="heading-font1">新增站点配置</span>
		            		...
		            		<table class="form-table" border="0" cellpadding="1" cellspacing="2" width="100%">
								<tr>
									...
									<td class="form-editor">
										<input id="configKey" name="configKey" class="easyui-textbox" style="width: 350px;" data-options="required:true"/>
									</td>
									<td class="form-label">
								...
								<tr>
									...
									<td class="form-editor">
										<input id="image" name="image" class="easyui-filebox" style="width: 350px;"
											   data-options="required: false,buttonText: '选择图片',
	...
	<script type="text/javascript">
		...
		$("#save").bind("click",function(){
			...
			//提交到后台
			/*$.ajax({
				url: "/website/stand/saveConfigInfo",
                type: 'POST',
                dataType: 'json',
                data: data,
                success: function(resp){

        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <span class="heading-font1">编辑敏感词汇</span>
                ...
                <div class="panel-body">
                    <form id="taskedit-form" method="post" data-options="novalidate:true">
                        <input id="contentId" name="contentId" type="hidden" class="easyui-textbox"/>
                                ...
                                <form id="taskadd-form" method="post" data-options="novalidate:true">
                                    <table class="form-table" border="0" cellpadding="1" cellspacing="2" width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td class="form-editor">
                                                <input id="enjoinOverDate" name="enjoinOverDate"
...
<script type="text/javascript">
    ...
    //ajax 加载form表单数据
    $.ajax({
        url: "${pageContext.request.contextPath}/website/confineContent/queryConfineContentById",
        type: 'GET',
        dataType: 'json',
    ...
    $("#save").bind("click", function () {
        ...
        //提交到后台
        $.ajax({
            url: "${pageContext.request.contextPath}/website/confineContent/updateConfineContent",
            type: 'PUT',
            dataType: 'json',
            data: data,
            success: function (resp) {

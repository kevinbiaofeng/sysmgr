...
<body>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading" >
		             	<span class="heading-font1">编辑签到配置</span>
		            ...
		            <div class="panel-body">
		            	<form id="taskedit-form" method="post" data-options="novalidate:true" >
							<input id="signid" name="signid" type="hidden" class="easyui-textbox" />
	...
	<script type="text/javascript">
		...
		//ajax 加载form表单数据
		$.ajax({
			url: "${pageContext.request.contextPath}/uphold/sign/queryGameSignInById",
			type: 'GET',
			dataType: 'json',
			...
			success: function(resp){
				...
				if(resp.success){
					...
					$('#taskedit-form').form("load",{
						signid: resp.data.signid,
						needday: resp.data.needday,
		...
		$("#save1").bind("click",function(){
			...
			//提交到后台
			$.ajax({
				url: "${pageContext.request.contextPath}/uphold/sign/updateGameSignIn",
                type: 'PUT',
                dataType: 'json',
                data: data,
                success: function(resp){

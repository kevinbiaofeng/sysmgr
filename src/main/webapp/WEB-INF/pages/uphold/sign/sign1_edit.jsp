			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading" >
		             	<span class="heading-font1">编辑签到礼包配置</span>
		            ...
		            <div class="panel-body">
		            	<form id="taskedit-form" method="post" data-options="novalidate:true" >
							<input id="packageid" name="packageid" type="hidden" class="easyui-textbox" />
								...
								<tr>
									...
									<td class="form-editor">
										<input id="platformkind" name="platformkind" class="easyui-combobox"
											   data-options="valueField:'id',textField:'text',
													   	data:[{id: 0,text: 'LUA'}
<%--													   	,{id: 1,text: 'U3D'},{id: 2,text: 'H5'},{id: 3,text: '通用'}--%>
													   	]" value="0"/>
									</td>
								</tr>
								<tr>
	...
	<script type="text/javascript">
		...
		//ajax 加载form表单数据
		$.ajax({
			url: "${pageContext.request.contextPath}/uphold/sign/queryGamePackageById",
			type: 'GET',
			dataType: 'json',
			data: {packageid: param.packageid},
			success: function(resp){
				...
				if(resp.success){
					...
					$('#taskedit-form').form("load",{
						...
						platformkind: resp.data.platformkind,
		...
		$("#save1").bind("click",function(){
			...
			//提交到后台
			$.ajax({
				url: "${pageContext.request.contextPath}/uphold/sign/updateGamePackage",
                type: 'PUT',
                dataType: 'json',
                data: data,
                success: function(resp){

...
<body>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading" >
		             	<span class="heading-font1">编辑每日分享配置</span>
	...
	<script type="text/javascript">
		...
		//ajax 加载form表单数据
		$.ajax({
			url: "${pageContext.request.contextPath}/uphold/share/queryShareConfigById",
			type: 'GET',
			dataType: 'json',
			data: {id: param.id},
			success: function(resp){
				...
				if(resp.success){
					...
					$('#taskedit-form').form("load",{
						id: resp.data.id,
						daysharelmt: resp.data.daysharelmt,
						nullity: resp.data.nullity,
						timesharegold: resp.data.timesharegold
		...
		$("#save1").bind("click",function(){
			...
			//提交到后台
			$.ajax({
				url: "${pageContext.request.contextPath}/uphold/share/updateShareConfig",
                type: 'PUT',
                dataType: 'json',
                data: data,
                success: function(resp){

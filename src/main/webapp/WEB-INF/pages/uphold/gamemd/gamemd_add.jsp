...
<body>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading" >
		             	<span class="heading-font1">新增游戏模块</span>
		            		...
		            		<table class="form-table" border="0" cellpadding="1" cellspacing="2" width="100%">
								<tr>
									...
									<td class="form-editor">
										<input id="gameid" name="gameid" class="easyui-numberbox" data-options="required:true"/>
									</td>
									<td class="form-label">
	...
	<script type="text/javascript">
		...
		$("#save").bind("click",function(){
			...
			//提交到后台
			$.ajax({
				url: "${pageContext.request.contextPath}/uphold/gamemd/saveGamemd",
                type: 'POST',
                dataType: 'json',
                data: data,

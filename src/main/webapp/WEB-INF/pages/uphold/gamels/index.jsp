							...
							<table class="form-table" border="0" cellpadding="1" cellspacing="2">
								<tr>
									...
									<td class="form-editor">
										<input id="kindname" name="kindname" class="easyui-textbox" />
									</td>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel-body" >
					...
					<table id="datagrid1" class="easyui-datagrid" title="游戏列表"
						...
						<thead>
							<tr>
								...
								<th data-options="field:'kindid',align:'center',fixed:false,width:30">游戏标识</th>
								<th data-options="field:'kindname',align:'center',fixed:false,width:30">游戏名称</th>
								<th data-options="field:'modulename',align:'center',fixed:false,width:30">安装包名</th>
								<th data-options="field:'clientversionDesc',align:'center',fixed:false,width:30">模版版本号</th>
								<th data-options="field:'resversion',align:'center',fixed:false,width:30">资源版本号</th>
								<th data-options="field:'sortid',align:'center',fixed:false,width:30">排序</th>
								<th data-options="field:'kindmarkDesc',align:'center',fixed:false,width:30">游戏归属</th>
	...
	<script type="text/javascript">
		...
		$(function($){
			...
			$("#add").bind("click",function(){
				$('#dialog').dialog({
					title: '新增游戏',
					href: '${pageContext.request.contextPath}/uphold/gamels/toGamelsAddPage',
					width: 800,
					height: 400,
					closed: false,
					cache: false,
		...
		function search(){
			...
			$('#datagrid1').datagrid({
				url: '${pageContext.request.contextPath}/uphold/gamels/queryGamelsWithPage',
				queryParams : {
		...
		function optortion(value,row,index){
			var a = $.rowFormater('kindid',row,'edit',{edit: '编辑'});
			return a;
		}
		...
		function openEditWindown(id){
			$('#dialog').dialog({
				title: '修改任务',
				href: '${pageContext.request.contextPath}/uphold/gamels/toGamelsEditPage',
				dialogParams: {kindid: id},
				width: 800,
				height: 400,
				closed: false,
				cache: false,

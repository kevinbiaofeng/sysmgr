...
<body>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading" >
		             	<span class="heading-font1">编辑排行配置</span>
	...
	<script type="text/javascript">
		...
		//ajax 加载form表单数据
		$.ajax({
			url: "${pageContext.request.contextPath}/uphold/rank/queryRankById",
			type: 'GET',
			dataType: 'json',
			...
			success: function(resp){
				...
				if(resp.success){
					...
					$('#taskedit-form').form("load",{
						...
						//awardticket: resp.data.awardticket,
						//diamond: resp.data.diamond,
						gold: resp.data.gold,
						ranktype: resp.data.ranktype,
		...
		$("#save").bind("click",function(){
			...
			//提交到后台
			$.ajax({
				url: "${pageContext.request.contextPath}/uphold/rank/updateRank",
                type: 'PUT',
                dataType: 'json',
                data: data,
                success: function(resp){

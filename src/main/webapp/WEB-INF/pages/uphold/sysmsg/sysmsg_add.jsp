...
<body>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading" >
		             	<span class="heading-font1">新增系统消息</span>
	...
	<script type="text/javascript">
		...
		$('#serverrange').tree({
			url:'${pageContext.request.contextPath}/uphold/sysmsg/loadGameIndoData',
			method:'GET',
			animate:true,
			checkbox:true
		});
		...
		$("#save").bind("click",function(){
			...
			//提交到后台
			$.ajax({
				url: "${pageContext.request.contextPath}/uphold/sysmsg/saveSysmsg",
                type: 'POST',
                dataType: 'json',
                data: data,

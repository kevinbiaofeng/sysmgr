...
<body>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading" >
		             	<span class="heading-font1">编辑任务信息</span>
		            ...
		            <div class="panel-body">
		            	<form id="taskedit-form" method="post" data-options="novalidate:true" >
							<input id="taskid" name="taskid" type="hidden" class="easyui-textbox" />
	...
	<script type="text/javascript">
		...
		//ajax 加载form表单数据
		$.ajax({
			url: "${pageContext.request.contextPath}/account/task/queryTaskById",
			type: 'GET',
			dataType: 'json',
		...
		$("#save").bind("click",function(){
			...
			//提交到后台
			$.ajax({
				url: "${pageContext.request.contextPath}/account/task/updateTask",
                type: 'PUT',
                dataType: 'json',
                data: data,
                success: function(resp){

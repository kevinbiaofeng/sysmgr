			...
			<div class="col-lg-12">
				<div class="panel panel-default">
		            ...
		            <div class="panel-body">
		            	<form id="reggiveadd-form" method="post" data-options="novalidate:true" >
...
<%--										,{id: 2,text: 'U3D'},{id: 3,text: 'H5'}--%>
	...
	<script type="text/javascript">
		...
		$("#save").bind("click",function(){
			...
			// 启用验证
			var isValid = $('#reggiveadd-form').form('enableValidation').form('validate');
			if(!isValid){
			...
			// 所有字段有效
			var obj = $("#reggiveadd-form").serializeObject();
			//console.log(obj);
			...
			var data = {
				...
				withdrawupperlimit: obj.withdrawupperlimit < 0 ? 0 : obj.withdrawupperlimit,
				withdrawlowerlimit: obj.withdrawlowerlimit < 0 ? 0 : obj.withdrawlowerlimit,
				withdrawratio: obj.withdrawratio < 0 ? 0 : obj.withdrawratio,
			...
			//提交到后台
			$.ajax({
				url: "${pageContext.request.contextPath}/account/reggive/saveReggive",
                type: 'POST',
                dataType: 'json',
                data: data,

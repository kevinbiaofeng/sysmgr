    ...
    tabMenu.prototype.storage = function (data, action) {
        ...
        if (action == "add") {
            ...
            if (menulist) {
                ...
                storage[appid + "_menu"] = menu;
            } else {
                storage[appid + "_menu"] = _data;
            }
            ...
            if (action == "close") {
                ...
                storage[appid + "_menu"] = menulist.join("|");
                storage.removeItem("curMenu");
        ...
        if (lastTab && this.config.freshLastTab) {
            //console.info('fresh[0]'+this.config.freshLastTab);
            this.fresh(0);
        }
    }

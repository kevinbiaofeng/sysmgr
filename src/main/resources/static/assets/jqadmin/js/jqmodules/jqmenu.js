...
layui.define(['jquery', 'laytpl', 'tabmenu', 'layer', 'elem'], function(exports) {
    ...
    jqmenu.prototype.tabmenu = function(){
        return tabmenu;
    }
    /**
     *@设置请求参数
    ...
    jqmenu.prototype.openOldMenu = function() {
        ...
        if (storage[appid+"_menu"]) {
            var menulist = storage[appid+"_menu"];
        ...
        if (storage.curMenu && storage.curMenu != "undefined") {
            var menu = storage.curMenu;
    ...
    jqmenu.prototype.uniq = function(arr) {
    	const res = new Map();
    ...
    jqmenu.prototype.menuShowType = function(type) {
        ...
        switch (showType) {
            case 2:
                ...
                if (false && this.options.icon) { //隐藏主菜单文字
